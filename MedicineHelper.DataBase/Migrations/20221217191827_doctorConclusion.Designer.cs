...
namespace MedicineHelper.DataBase.Migrations
{
    ...
    [Migration("20221217191827_doctorConclusion")]
    partial class doctorConclusion
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MedicineHelper.DataBase.Entities.DoctorVisit", b =>
                {
                    ...
                    b.HasIndex("ConclusionId")
                        .IsUnique()
                        .HasFilter("[ConclusionId] IS NOT NULL");
            ...
            modelBuilder.Entity("MedicineHelper.DataBase.Entities.DoctorVisit", b =>
                {
                    ...
                    b.HasOne("MedicineHelper.DataBase.Entities.Conclusion", "Conclusion")
                        .WithOne("DoctorVisit")
                        .HasForeignKey("MedicineHelper.DataBase.Entities.DoctorVisit", "ConclusionId");
